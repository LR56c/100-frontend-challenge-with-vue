...
<template>
	<div class="flex gap-4">
		<img class="aspect-square object-cover object-center w-24 h-24 min-w-24 max-w-24 rounded-2xl" :src="img"/>
		<div class="flex flex-col justify-center gap-4 w-64">
			<div class="flex justify-between items-center">
				<div class="font-medium">{{ name }}</div>
				<Icon class="opacity-70" @click="emit('removeItem', name)" size="20" name="ic-round-close"/>
			</div>
