...
const {seenCount} = useNotification()
</script>
...
<Popover>
	<PopoverTrigger as-child>
		<button class="relative w-8 h-8 rounded-full shadow-lg flex justify-center items-center">
			<span v-if="seenCount > 0" class="absolute z-10 top-2 right-2 w-1.5 h-1.5 bg-rose-500 rounded-full"></span>
			<Icon
				:class="[seenCount > 0 ? 'opacity-70' : 'opacity-20']"
				 size="20" name="ic-baseline-notifications-none"/>
		</button>
	</PopoverTrigger>
