...
const subtotal = computed( () => {
	return Array.from( listRef.value.values() )
	            .reduce( ( acc, item ) => {
			...
			<div class="flex flex-col gap-4">
				<div class="shadow-lg rounded-2xl flex flex-col bg-white">
					...
					<div class="p-4 flex flex-col gap-4">
						...
						<button class="my-4 bg-black text-white py-2 w-full rounded-2xl">Pay
							now
						</button>
					</div>
				</div>
				<div class="shadow-lg rounded-2xl flex flex-col p-4 bg-white">
					<label for="code"
						class="text-lg block mb-2 font-medium text-gray-900">Promo
						Code</label>
					<input type="text"
						id="code"
						class="rounded-2xl bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
